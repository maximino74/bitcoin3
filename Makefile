#############################################################################
# Makefile for building: bitcoin3-qt
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = bitcoin3-qt0.8.7.5
DISTDIR = /home/coin/bitcoin3/build/bitcoin3-qt0.8.7.5
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lminiupnpc /home/coin/bitcoin3/src/leveldb/libleveldb.a /home/coin/bitcoin3/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lQt5Widgets -lQt5Gui -lQt5Network -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/coin/bitcoin3/src/leveldb/libleveldb.a; cd /home/coin/bitcoin3/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/coin/bitcoin3/src/leveldb/libleveldb.a: FORCE
	cd /home/coin/bitcoin3/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/coin/bitcoin3/build/build.h: FORCE
	cd /home/coin/bitcoin3; /bin/sh share/genbuild.sh /home/coin/bitcoin3/build/build.h
...
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/home/coin/bitcoin3 -I/home/coin/bitcoin3/src -I/home/coin/bitcoin3/src/json -I/home/coin/bitcoin3/src/qt -I/home/coin/bitcoin3/src/leveldb/include -I/home/coin/bitcoin3/src/leveldb/helpers -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp
